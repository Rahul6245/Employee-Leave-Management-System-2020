...
<label for="subject">Subject</label>
    <textarea id="subject" name="subject" placeholder="Write The Notice Here..." style="height:200px"></textarea>

    <input type="submit" name ="done"  value="Post The Notice"></form><br>
...
if(isset($_POST['done'])){
     ...
     $query="INSERT INTO `notice`(`subject`) VALUES ('$subject')";
